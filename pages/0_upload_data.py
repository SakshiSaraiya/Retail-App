...
with st.container():
    ...
    with st.container():
        with st.expander("Upload Product CSV"):
            product_file = st.file_uploader("", type=["csv"], key="product")
            if product_file:
        ...
        with st.expander("Upload Purchase CSV"):
            purchase_file = st.file_uploader("", type=["csv"], key="purchase")
            if purchase_file:
        ...
        with st.expander("Upload Sales CSV"):
            sales_file = st.file_uploader("", type=["csv"], key="sales")
            if sales_file:
